...
// 12.08.2026 Дошел в Жашкевиче до 08 главы "Горутины и каналы" (включительно). Решил вернуться к началу.
// Остановился глава 03, стр. 35 "Срезы" (Керниган, 4.2 Slices, стр. 103).
// Пока займусь бээкендом в Битрикс24...
// Если пойдет к теории на прямую не вернусь, буду стараться продолжать этот проект параллельно!
//
// Продолжить здесь-
